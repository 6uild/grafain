...
// source: cmd/grafain/app/codec.proto

package grafain

import (
	fmt "fmt"
	artifact "github.com/alpe/grafain/pkg/artifact"
...
type Tx struct {
	...
	//	*Tx_CreateArtifactMsg
	//	*Tx_DeleteArtifactMsg
...
func (*Tx) Descriptor() ([]byte, []int) {
	return fileDescriptor_5825659af449633e, []int{0}
}
...
type Tx_CreateArtifactMsg struct {
	CreateArtifactMsg *artifact.CreateArtifactMsg `protobuf:"bytes,100,opt,name=create_artifact_msg,json=createArtifactMsg,proto3,oneof"`
}
type Tx_DeleteArtifactMsg struct {
	DeleteArtifactMsg *artifact.DeleteArtifactMsg `protobuf:"bytes,101,opt,name=delete_artifact_msg,json=deleteArtifactMsg,proto3,oneof"`
}
...
func (*Tx_CreateArtifactMsg) isTx_Sum()         {}
func (*Tx_DeleteArtifactMsg) isTx_Sum()         {}
...
func (m *Tx) GetCreateArtifactMsg() *artifact.CreateArtifactMsg {
	if x, ok := m.GetSum().(*Tx_CreateArtifactMsg); ok {
		return x.CreateArtifactMsg
	}
	return nil
}

func (m *Tx) GetDeleteArtifactMsg() *artifact.DeleteArtifactMsg {
	if x, ok := m.GetSum().(*Tx_DeleteArtifactMsg); ok {
		return x.DeleteArtifactMsg
	}
	return nil
}
...
func (*Tx) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Tx_OneofMarshaler, _Tx_OneofUnmarshaler, _Tx_OneofSizer, []interface{}{
		...
		(*Tx_CreateArtifactMsg)(nil),
		(*Tx_DeleteArtifactMsg)(nil),
	}
}
...
func _Tx_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Tx_CreateArtifactMsg:
		_ = b.EncodeVarint(100<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CreateArtifactMsg); err != nil {
			return err
		}
	case *Tx_DeleteArtifactMsg:
		_ = b.EncodeVarint(101<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.DeleteArtifactMsg); err != nil {
			return err
		}
	case nil:
	default:
...
func _Tx_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 78: // sum.gov_update_election_rule_msg
		...
		return true, err
	case 100: // sum.create_artifact_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(artifact.CreateArtifactMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &Tx_CreateArtifactMsg{msg}
		return true, err
	case 101: // sum.delete_artifact_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(artifact.DeleteArtifactMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &Tx_DeleteArtifactMsg{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Tx_OneofSizer(msg proto.Message) (n int) {
	...
	case *Tx_GovUpdateElectionRuleMsg:
		...
		n += s
	case *Tx_CreateArtifactMsg:
		s := proto.Size(x.CreateArtifactMsg)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Tx_DeleteArtifactMsg:
		s := proto.Size(x.DeleteArtifactMsg)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*ExecuteBatchMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_5825659af449633e, []int{1}
}
...
func (*ExecuteBatchMsg_Union) Descriptor() ([]byte, []int) {
	return fileDescriptor_5825659af449633e, []int{1, 0}
}
...
func (*ProposalOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_5825659af449633e, []int{2}
}
...
func (*ExecuteProposalBatchMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_5825659af449633e, []int{3}
}
...
func (*ExecuteProposalBatchMsg_Union) Descriptor() ([]byte, []int) {
	return fileDescriptor_5825659af449633e, []int{3, 0}
}
...
func (*CronTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_5825659af449633e, []int{4}
}
...
func init() {
	proto.RegisterType((*Tx)(nil), "grafain.Tx")
	proto.RegisterType((*ExecuteBatchMsg)(nil), "grafain.ExecuteBatchMsg")
	proto.RegisterType((*ExecuteBatchMsg_Union)(nil), "grafain.ExecuteBatchMsg.Union")
	proto.RegisterType((*ProposalOptions)(nil), "grafain.ProposalOptions")
	proto.RegisterType((*ExecuteProposalBatchMsg)(nil), "grafain.ExecuteProposalBatchMsg")
	proto.RegisterType((*ExecuteProposalBatchMsg_Union)(nil), "grafain.ExecuteProposalBatchMsg.Union")
	proto.RegisterType((*CronTask)(nil), "grafain.CronTask")
}

func init() { proto.RegisterFile("cmd/grafain/app/codec.proto", fileDescriptor_5825659af449633e) }

var fileDescriptor_5825659af449633e = []byte{
	// 1229 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Tx_DistributionCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionCreateMsg != nil {
		...
		n13, err := m.DistributionCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *Tx_DistributionMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionMsg != nil {
		...
		n14, err := m.DistributionMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *Tx_DistributionResetMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionResetMsg != nil {
		...
		n15, err := m.DistributionResetMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *Tx_MigrationUpgradeSchemaMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MigrationUpgradeSchemaMsg != nil {
		...
		n16, err := m.MigrationUpgradeSchemaMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *Tx_AswapCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AswapCreateMsg != nil {
		...
		n17, err := m.AswapCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *Tx_AswapReleaseMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AswapReleaseMsg != nil {
		...
		n18, err := m.AswapReleaseMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *Tx_AswapReturnMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AswapReturnMsg != nil {
		...
		n19, err := m.AswapReturnMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *Tx_GovCreateProposalMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovCreateProposalMsg != nil {
		...
		n20, err := m.GovCreateProposalMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *Tx_GovDeleteProposalMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovDeleteProposalMsg != nil {
		...
		n21, err := m.GovDeleteProposalMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *Tx_GovVoteMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovVoteMsg != nil {
		...
		n22, err := m.GovVoteMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *Tx_GovUpdateElectorateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovUpdateElectorateMsg != nil {
		...
		n23, err := m.GovUpdateElectorateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *Tx_GovUpdateElectionRuleMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovUpdateElectionRuleMsg != nil {
		...
		n24, err := m.GovUpdateElectionRuleMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *Tx_CreateArtifactMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CreateArtifactMsg != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x6
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.CreateArtifactMsg.Size()))
		n25, err := m.CreateArtifactMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *Tx_DeleteArtifactMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.DeleteArtifactMsg != nil {
		dAtA[i] = 0xaa
		i++
		dAtA[i] = 0x6
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DeleteArtifactMsg.Size()))
		n26, err := m.DeleteArtifactMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *ExecuteBatchMsg_Union) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Sum != nil {
		nn27, err := m.Sum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn27
...
func (m *ExecuteBatchMsg_Union_CashSendMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CashSendMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.CashSendMsg.Size()))
		n28, err := m.CashSendMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *ExecuteBatchMsg_Union_EscrowCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EscrowCreateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.EscrowCreateMsg.Size()))
		n29, err := m.EscrowCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *ExecuteBatchMsg_Union_EscrowReleaseMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EscrowReleaseMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.EscrowReleaseMsg.Size()))
		n30, err := m.EscrowReleaseMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *ExecuteBatchMsg_Union_EscrowReturnMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EscrowReturnMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.EscrowReturnMsg.Size()))
		n31, err := m.EscrowReturnMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *ExecuteBatchMsg_Union_EscrowUpdatePartiesMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EscrowUpdatePartiesMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.EscrowUpdatePartiesMsg.Size()))
		n32, err := m.EscrowUpdatePartiesMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *ExecuteBatchMsg_Union_MultisigCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MultisigCreateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.MultisigCreateMsg.Size()))
		n33, err := m.MultisigCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *ExecuteBatchMsg_Union_MultisigUpdateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MultisigUpdateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.MultisigUpdateMsg.Size()))
		n34, err := m.MultisigUpdateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *ExecuteBatchMsg_Union_ValidatorsApplyDiffMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ValidatorsApplyDiffMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.ValidatorsApplyDiffMsg.Size()))
		n35, err := m.ValidatorsApplyDiffMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *ExecuteBatchMsg_Union_CurrencyCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CurrencyCreateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.CurrencyCreateMsg.Size()))
		n36, err := m.CurrencyCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *ExecuteBatchMsg_Union_DistributionCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionCreateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DistributionCreateMsg.Size()))
		n37, err := m.DistributionCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *ExecuteBatchMsg_Union_DistributionMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DistributionMsg.Size()))
		n38, err := m.DistributionMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *ExecuteBatchMsg_Union_DistributionResetMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionResetMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DistributionResetMsg.Size()))
		n39, err := m.DistributionResetMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *ProposalOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Option != nil {
		nn40, err := m.Option.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn40
...
func (m *ProposalOptions_UpdateEscrowPartiesMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateEscrowPartiesMsg != nil {
		...
		n43, err := m.UpdateEscrowPartiesMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *ProposalOptions_MultisigUpdateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MultisigUpdateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.MultisigUpdateMsg.Size()))
		n44, err := m.MultisigUpdateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *ProposalOptions_ValidatorsApplyDiffMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ValidatorsApplyDiffMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.ValidatorsApplyDiffMsg.Size()))
		n45, err := m.ValidatorsApplyDiffMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *ProposalOptions_CurrencyCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CurrencyCreateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.CurrencyCreateMsg.Size()))
		n46, err := m.CurrencyCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *ProposalOptions_ExecuteProposalBatchMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExecuteProposalBatchMsg != nil {
		...
		n47, err := m.ExecuteProposalBatchMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *ProposalOptions_DistributionCreateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionCreateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DistributionCreateMsg.Size()))
		n48, err := m.DistributionCreateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *ProposalOptions_DistributionMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DistributionMsg.Size()))
		n49, err := m.DistributionMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *ProposalOptions_DistributionResetMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionResetMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DistributionResetMsg.Size()))
		n50, err := m.DistributionResetMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *ProposalOptions_MigrationUpgradeSchemaMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MigrationUpgradeSchemaMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.MigrationUpgradeSchemaMsg.Size()))
		n51, err := m.MigrationUpgradeSchemaMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *ProposalOptions_GovUpdateElectorateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovUpdateElectorateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.GovUpdateElectorateMsg.Size()))
		n52, err := m.GovUpdateElectorateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
...
func (m *ProposalOptions_GovUpdateElectionRuleMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovUpdateElectionRuleMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.GovUpdateElectionRuleMsg.Size()))
		n53, err := m.GovUpdateElectionRuleMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
...
func (m *ProposalOptions_GovCreateTextResolutionMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovCreateTextResolutionMsg != nil {
		...
		n54, err := m.GovCreateTextResolutionMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *ExecuteProposalBatchMsg_Union) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Sum != nil {
		nn55, err := m.Sum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn55
...
func (m *ExecuteProposalBatchMsg_Union_EscrowReleaseMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EscrowReleaseMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.EscrowReleaseMsg.Size()))
		n57, err := m.EscrowReleaseMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n57
...
func (m *ExecuteProposalBatchMsg_Union_UpdateEscrowPartiesMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateEscrowPartiesMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.UpdateEscrowPartiesMsg.Size()))
		n58, err := m.UpdateEscrowPartiesMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n58
...
func (m *ExecuteProposalBatchMsg_Union_MultisigUpdateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MultisigUpdateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.MultisigUpdateMsg.Size()))
		n59, err := m.MultisigUpdateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n59
...
func (m *ExecuteProposalBatchMsg_Union_ValidatorsApplyDiffMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ValidatorsApplyDiffMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.ValidatorsApplyDiffMsg.Size()))
		n60, err := m.ValidatorsApplyDiffMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n60
...
func (m *ExecuteProposalBatchMsg_Union_GovUpdateElectorateMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovUpdateElectorateMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.GovUpdateElectorateMsg.Size()))
		n64, err := m.GovUpdateElectorateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *ExecuteProposalBatchMsg_Union_GovUpdateElectionRuleMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovUpdateElectionRuleMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.GovUpdateElectionRuleMsg.Size()))
		n65, err := m.GovUpdateElectionRuleMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *ExecuteProposalBatchMsg_Union_GovCreateTextResolutionMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovCreateTextResolutionMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.GovCreateTextResolutionMsg.Size()))
		n66, err := m.GovCreateTextResolutionMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n66
...
func (m *CronTask) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Sum != nil {
		nn67, err := m.Sum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn67
...
func (m *CronTask_EscrowReturnMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EscrowReturnMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.EscrowReturnMsg.Size()))
		n69, err := m.EscrowReturnMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n69
...
func (m *CronTask_DistributionDistributeMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DistributionDistributeMsg != nil {
		...
		n70, err := m.DistributionDistributeMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n70
...
func (m *CronTask_AswapReleaseMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AswapReleaseMsg != nil {
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.AswapReleaseMsg.Size()))
		n71, err := m.AswapReleaseMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n71
...
func (m *CronTask_GovTallyMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GovTallyMsg != nil {
		...
		n72, err := m.GovTallyMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n72
...
func (m *Tx_CreateArtifactMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CreateArtifactMsg != nil {
		l = m.CreateArtifactMsg.Size()
		n += 2 + l + sovCodec(uint64(l))
	}
	return n
}
func (m *Tx_DeleteArtifactMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Tx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 100:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreateArtifactMsg", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &artifact.CreateArtifactMsg{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Tx_CreateArtifactMsg{v}
			iNdEx = postIndex
		case 101:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteArtifactMsg", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &artifact.DeleteArtifactMsg{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Tx_DeleteArtifactMsg{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
