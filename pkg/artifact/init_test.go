...
func TestGenesisInitializer(t *testing.T) {
	...
	assert.Equal(t, "foo/bar:v1", first.Image)
	...
	assert.Equal(t, "prom/prometheus@sha256:97b61971c9bfd43337423c56d5209a288487eaecb05165bd1636176d381d9e4c", second.Image)
